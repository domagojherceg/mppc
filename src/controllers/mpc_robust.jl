...
MPC controller with single control trajectory shared across all scenarios.
"""

"""
    buildSMPC_RK4_robust(
        scf, scenV, scenP; 
        Ts = 1, 
        numWeeks = 12, 
        umax = 0.75, 
...
Build robust stochastic MPC controller with single control trajectory.
...
function buildSMPC_RK4_robust( scf, scenV, scenP; 
    Ts = 1, 
    numWeeks = 12, 
    umax = 0.75, 
    T_max = 0.002, 
